...
class PySpinBoxPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):

    """PySpinBoxPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin)
    ...
    def __init__(self, parent=None):
        ...
        super(PySpinBoxPlugin, self).__init__(parent)
    ...
    def domXml(self):
        return '<widget class="SpinBox" name="SpinBox">\n' \
               ' <property name="toolTip">\n' \
               '  <string>pyqtgraph SpinBox</string>\n' \
               ' </property>\n' \
               ' <property name="whatsThis">\n' \
               '  <string> QSpinBox widget on steroids.' \
               '</string>\n' \
               ' </property>\n' \
               '</widget>\n'
